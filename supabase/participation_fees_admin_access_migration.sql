...
grant execute on function public.manager_mark_participants_fully_paid(uuid[], uuid)
  to authenticated;
grant execute on function public.manager_mark_participants_fully_paid(uuid[], uuid)
  to service_role;
...
revoke all on function public.manager_import_participation_fee_bank_payments(jsonb, uuid)
  from public;
grant execute on function public.manager_import_participation_fee_bank_payments(jsonb, uuid)
  to authenticated;
grant execute on function public.manager_import_participation_fee_bank_payments(jsonb, uuid)
  to service_role;
